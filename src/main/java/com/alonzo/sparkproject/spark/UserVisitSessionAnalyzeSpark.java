...
public class UserVisitSessionAnalyzeSpark {
	...
	public static void main(String[] args) {
		...
		JSONObject taskParm = JSONObject.parseObject(task.getTaskName());
		
		// 如果要进行session粒度的数据聚合
		// 首先要从user_visit_action表中，查询出来指定日期范围内的行为数据
		JavaRDD<Row> actionRDD = getActionRDDByDateRange(sqlContext, taskParm);
		...
		JavaPairRDD<String, String> filteredSessionid2AggrInfoRDD = 
				filterSession(sessionid2AggrInfoRDD, taskParm);
